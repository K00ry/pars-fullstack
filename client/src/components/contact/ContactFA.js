  ...
  <Container>
    ...
    <Row className="contact-fa" data-scroll="toggle(.fromTopIn, .fromTopOut)">
      <Col sm={4} className="contact-fa__line text-right">
        ...
        <a className="contact-fa__line--a" href="tel:+989121180175">
          ۰۹۱۲-۱۱۸-۰۱۷۵
        </a>
        <br />
        <a className="contact-fa__line--a" href="tel:+989123368183">
          ۰۹۱۲-۳۳۶-۸۱۸۳
        </a>
      </Col>
      <Col sm={4} className="contact-fa__line text-right">
        ...
        <a className="contact-fa__line--a" href="mailto:info@parsjadval.ir">
          info@parsjadval.ir
        </a>
      </Col>
      <Col sm={4} className="contact-fa__line text-right">
        <h5 className="contact-fa__line--h5">آدرس</h5>
        <div className="contact-fa__line--a">
          ورامین بعد از میدان ولیعصر جنب کوی جعفر آباد
        </div>
      </Col>
    </Row>
  </Container>
