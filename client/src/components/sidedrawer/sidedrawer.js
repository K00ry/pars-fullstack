                ...
                return(
                    <div id="mySidenav" className={`${this.props.t("lang-class")} ${sideDraw}`}>
                        ...
                        <ul className={`sideNav-title ${this.props.t("lang-class")}`}>
                            <li className="sidenav-home" onClick={actions.handleOpeningDrawer}>
                            ...
                            <li className="sidenav-noSub">
                                <Link to="/load-in" className="sidenav-noSub__Link" onClick={actions.handleOpeningDrawer}>
                                    <div className="sidenav-noSub__Link--font">{this.props.t("loadIn")}</div>
                                </Link>
                            </li>
                            <li className="sidenav-noSub">
                                <Link to="/lab" className="sidenav-noSub__Link" onClick={actions.handleOpeningDrawer}>
                                    <div className="sidenav-noSub__Link--font">{this.props.t("lab")}</div>
                                </Link>
                            </li>
                            <li className="sidenav-noSub">
                                <Link to="/about" className="sidenav-noSub__Link" onClick={actions.handleOpeningDrawer}>
                                    <div className="sidenav-noSub__Link--font">{this.props.t("about")}</div>
                                </Link>
                            </li>
                            <li className="sidenav-noSub">
                                <Link to="/catalog" className="sidenav-noSub__Link" onClick={actions.handleOpeningDrawer}>
                                    <div className="sidenav-noSub__Link--font">{this.props.t("catalog")}</div>
                                </Link>
                            </li>
                            <li className="sidenav-noSub">
                                <Link to="/contact" className="sidenav-noSub__Link" onClick={actions.handleOpeningDrawer}>
